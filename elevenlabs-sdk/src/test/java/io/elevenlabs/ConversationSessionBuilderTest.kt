...
class ConversationSessionBuilderTest {
    ...
    @Test
    fun `build works with valid config`() =
        runTest {
            val config = ConversationConfig(conversationToken = "test-token")
            val builder =
                ConversationSessionBuilder(mockContext)
                    .config(config)
    ...
    @Test
    fun `build registers custom ClientTool`() =
        runTest {
            val config = ConversationConfig(conversationToken = "test-token")
            val builder =
                ConversationSessionBuilder(mockContext)
    ...
    @Test
    fun `build registers function-based tool`() =
        runTest {
            val config = ConversationConfig(conversationToken = "test-token")
    ...
    @Test
    fun `function-based tool executes correctly`() =
        runTest {
    ...
    @Test
    fun `function-based tool handles exceptions`() =
        runTest {
            var capturedTool: ClientTool? = null
    ...
    @Test
    fun `builder pattern allows method chaining`() =
        runTest {
            val config = ConversationConfig(conversationToken = "test-token")
